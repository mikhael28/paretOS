export const en = {
  // this is the English text for ParetOS≈
  appTitle1: "Pareto",
  email: "Email",
  login: "Sign In",
  logout: "Logout",
  ...
  firstLanding: `Learn to code & level-up your mindset with friends and mentors in our community to keep you accountable.`,
  ...
  appFirst:
    "In the Full Stack Apprenticeship, you will complete a set of step-by-step projects and tasks and send them to your mentor for review. These will guide you from setting up your development environment, all the way through",
  appSecond:
    'The Pareto Arena is where put your work ethic and habits to the test. Success in a field like the tech industry can be demanding, and it requires a lifestyle that you can maintain in the long term. By engaging in "sprints", you can track your work and lifestyle habits over the course of 5 days - and see how consistently you are able to maintain a schedule that of a top-performer in your field.',
  appThird: `The Library of Context is a place for you to learn the 20% of knowledge that will give you 80% of context in the tech industry, specifically full-stack development. It's not just tutorials and articles - we link to job boards, industry development programs and also have a guide for each city our members are in. This way, we can share knowledge quickly and effectively.`,
  appFourth:
  ...
  appFifth:
    "Press Command+K to open the command palette. You can quickly bounce around between different pages on the OS, as well as simply search for a particular topic. If it's contained in our Library of Context, you can press enter and that article will be pulled up and displayed (if the iFrame rules allow it. If not, it will open a new tab.",
  appSixth:
  ...
  termsOfService:
    "This is our limited Terms of Service: The following sets forth the agreement (this “Agreement”) between you and the owners of ParetOS (“Michael Litchev”, “we” or “us”) under which you may enable and use the the ParetOS (the “Software” or the “Send Me a Sample Service”). The code for the front-end of the ParetOS is open-source under the GNU Public License 2.0. Additionally, the Pareto Leaerning, ParetOS, Paret0 brand, the Library of Context and it's contents, the Learning modules and it's contents, are owned exclusively by Michael Litchev. You may not use these materials in personal projects or other business ventures, and you may not use these resources as a 'template' for writing derivative works. You acknowledge that, prior to creating an account, enabling any related skill or data capture form and using the platform, you have read and understood the terms of this agreement, without modification. By using the software, you agree to be bound by the terms of this agreement and to comply with all applicable laws and regulations. If you do not agree to these terms, do not use the platform. In the future, we will add a specific page that contains the most recent Terms of Service. The most current version will supersede all previous versions. By continuing to use the ParetOS after changes are made, you agree to be bound by such changes. You also acknowledge that you have read and understood the Privacy Policy which explains how we will use any personal data you give us when using the Software.",
}