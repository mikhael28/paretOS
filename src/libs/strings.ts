...
export const strings = {
  ...
  es: {
    ...
    country: "País",
    phone: "Teléfono",
    basicTraining: "Entrenamiento Básico",
    ...
    back: "Espalda",
    next: "Siguiente",
    submitProof: "Envie Prueba de Finalización",
    ...
    // new for translation
    // new for Primrose
    createTemplate: "Crear un templete de sprint",
    editTemplateName: "Editar el nombre del templete",
    startNewSprint: "Empezar un nuevo Sprint",
    editName: "Editar nombre",
    changePicture: "Cambiar foto de perfil",
    cancel: "Cancelar",
    organization: "Organizacion",
    bio: "Biografia Publica",
    school: "Escuela",
    pleaseChooseAnOption: "Elije una opcion",
    projects: "Proyectos",
    projectName: "Nombre del proyecto",
    projectIdeas: "Notas e ideas del proyecto",
    noIdeasYet:
      "¿No tienes ideas de proyectos? Haz click en el boton para agregar una.",
    noProjectsYet:
      "¿No tienes proyectos activos? Haz click en el boton para agregar uno.",
    enterNewProjectIdea: "Ingresa nueva idea para proyecto",
    save: "Guardar",
    githubRepository: "Repositorio GitHub",
    ifNoSprints: "Empieza un nuevo sprint haciendo click en el enlace!",
    viewSprint: "Ver Sprint",
    myMentees: "Mis aprendices",
    options: "Opciones",
    morning: "Mañana",
    workday: "Dia de trabajo",
    evening: "Tarde",
    sabbath: "Sabbath",
    weekend: "Fin de semana",
    loading: "Cargando",
    selectTemplate: "Escoje tu templete de Sprint",
    selectPlayers: "Escoje tus competidores",
    trashTalkPSA:
      "Opcional: Tirar mierda. Envia un mensaje motivacional o desmotivacional a tu rival.",
    viewProof: "Ver prueba",
    noProof: "No se agrego prueba",
    arenaNav: "Estadio",
    learnNav: "Aprender",
    libraryNav: "Libreria",
    chatNav: "Chatear",
    profileNav: "Perfil",
    chatroom: "Chat de la liga",
    ...
    streetAddress: "Nombre de calle",
    creditCardInfo: "Informacion de tarjeta de credito",
    myMentors: "Mis mentores",
    apprenticeship: "Aprendiz Full-Stack",
    myCareer: "MiCarrera",
    cheatsheets:
      "14 Hojas de trucos laminadas, con el 20% del conocimiento necesario para llegar al 80% de los resultados que buscas.",
    flashcards:
      "52 Tarjetas-flash, el cual se dobla como una baraja, para aprender el centro de los metodos JavaScript y APIs.",
    stickers:
      "Calcomanias de corriente de trabajo, ayudando a memorizar comandos cruciales de la terminal usando Git, AWS Amplify y Bash.",
    workbooks:
      "Libro de trabajo fisico interactivo para ayudarte a idear la piedra angular del portafolio de tu proyecto/producto, diseñar borradores con marco de alambre, modelar la informacion a guardar en tu base de datos, crear un diagrama arquitectonico, y mas.",
    support: "Ayuda prioritaria y primer acceso a las nuevas características.",
    lifetime: "Acceso de por vida a la base de conocimiento y estadio",
    purchase: "Comprar",
    morningTitle: "Rutina mañanera para el exito",
    morningSummary:
      "Empieza tu dia con la intencion adecuada -  re-escribe tus metas, expresa verbalmente afirmaciones positivas y gratitud. Come comida. Ejercicios Calestenicos.",
    dailyExcerciseTitle: "Ejercicio Diario",
    exerciseSummary:
      "20 minutos de ejercicio intenso o 30 minutos de ejercicio moderado al menos una hora despues de despertar.",
    meditation: "Meditacion",
    meditationSummary:
      "Inmediatamente despues de la comida, alrededor de la 1 o 2, medita evitar golpear atraves del desemeño.",
    eveningTitle: "Rutina para la tarde para exito",
    eveningSummary:
      "Desconectate de electronicos (excepto Kindle E-Ink). Reflexiona y anota en los eventos del dia que hiciste bien, que puedes mejorar, que agradeces. Duerme 8 horas si es posible, 7 minimo.",
    consistencyTitle: "La consistencia es el rey",
    consistencySummary:
      "Despierta todos los dias a la misma hora y registrate en la app Pareto en 5 minutos maximo.",
    deepWork: "3 Horas de trabajo profundo",
    deepWorkSummary:
      "Registra tu entrada y salida. No hay substituto para poner en el trabajo, si es tu 9-5, tu arte o tu creacion.",
    eveningCreativity: "Creatividad vespertina",
    creativitySummary:
      "No importa si es tocar un instrumento, leer, escribir o algo enemdio - haz algo especial, creativo y relajante en la noche.",
    noSmoking: "No fumar nicotina",
    noSmokingSummary:
      "Crea una adiccion a la dopamina de corto plazo que invalida tu habilidad de desempeñarte a un nivel de clase mundial. Responde a esto inmediatamente despues de tu rutina de noche.",
    noDrinking: "No alcohol entre semana",
    noDrinkingSummary:
      "Para desempeñar a un nivel de clase mundial, necesitas concentrar toda tu concentracion y energia. Abstenserse de alcohol entre semana te ayuda a dormir mejor y tener mas energia al siguiente dia.",
    eatTheFrog: "Come Rana",
    frogSummary:
      "Esta expresion significa lograr tu objetivo diario principal. Cada dia hay algo que es realmente importante. ¿Haz terminado aquella cosa?",
    secondGoal: "Come otra Rana",
    secondFrogSummary:
      "Hay un elemento que es segundo en importancia despues de comer rana. ¿Lo terminaste?",
  },
  lg: {
    appTitle1: "Pareto",
